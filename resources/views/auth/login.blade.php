...
<head>
    ...
    <head>
        ...
        <title>Login | Munchies Dashboard</title>
                    ...
                    <div class="card-header bg-primary">
                        <div class="app-brand">
                            <a href="">
                                ...
                                <span class="brand-name">Munchies Dashboard</span>
                            </a>
                        </div>
                    </div>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 mb-4">
                                    ...
                                    value="{{ old('username') }}" required autofocus  aria-describedby="emailHelp"
                                    name="username" placeholder="Username">
                                </div>

                                {{-- Password --}}
                                <div class="form-group col-md-12 ">
                                    <input type="password" name="password" required class="form-control input-lg" id="password"
