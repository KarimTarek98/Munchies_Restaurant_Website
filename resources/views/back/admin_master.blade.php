...
<head>
    ...
    <link href="{{ asset('back/assets/plugins/ladda/ladda.min.css') }}" rel="stylesheet" />
...
<body class="sidebar-fixed sidebar-dark header-light header-fixed" id="body">
    ...
    <script src="{{ asset('back/assets/plugins/ladda/ladda.min.js') }}"></script>
    <script src="{{ asset('back/assets/plugins/jquery-mask-input/jquery.mask.min.js') }}"></script>
    <script src="{{ asset('back/assets/plugins/select2/js/select2.min.js') }}"></script>
    <script src="{{ asset('back/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js') }}"></script>
    <script src="{{ asset('back/assets/plugins/jvectormap/jquery-jvectormap-world-mill.js') }}"></script>
    ...
    <script src="{{ asset('back/assets/plugins/jekyll-search.min.js') }}"></script>
    <script src="{{ asset('back/assets/js/sleek.js') }}"></script>
